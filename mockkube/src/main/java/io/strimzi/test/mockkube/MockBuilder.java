...
class MockBuilder<T extends HasMetadata,
    ...
    protected T copyResource(T resource) {
        ...
        /*try {
            // TODO
            R instance = resourceClass.getDeclaredConstructor(resourceTypeClass).newInstance(resource);
            // return (T) instance.getClass().getMethod("done").invoke(instance);
            return resource;
    ...
    protected void nameScopedMocks(String resourceName, R resource) {
        ...
        // TODO
        //when(resource.create()).thenReturn(resource.create());
